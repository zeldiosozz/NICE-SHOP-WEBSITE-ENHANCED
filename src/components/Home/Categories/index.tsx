    ...
    <section className="overflow-hidden pt-7.5">
      <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0 pb-15 border-b border-gray-3">
        <div className="swiper categories-carousel common-carousel">
          {/* <!-- section title --> */}
          <div className="category_title mb-10 flex items-center justify-between">
            <div>
            ...
            <div className="flex items-center gap-3">
              <button onClick={handlePrev} className="swiper-btn-next">
                <svg
              ...
              <button onClick={handleNext} className="swiper-btn-next">
                <svg
                  className="fill-current"
                  width="24"
                  height="24"
