            ...
            <div className="mb-10 flex items-center justify-between">
              <div>
                <span className="flex items-center gap-2.5 font-medium text-[#1C274C] dark:text-[#ffffff] mb-1.5">
                  <Image
                    src="https://res.cloudinary.com/dj8hypsia/image/upload/v1760984870/call-center_gp7sr8.png"
                    alt="icon"
                    width={30}
                    height={17}
                  />
              ...
              <div className="flex items-center gap-3">
                <div onClick={handlePrev} className="swiper-btn-next">
                  <svg
                ...
                <div onClick={handleNext} className="swiper-btn-next">
                  <svg
                    className="fill-current"
                    width="24"
                    height="24"
