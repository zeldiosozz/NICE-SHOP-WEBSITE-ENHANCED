...
>
  <svg
    ...
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    className="fill-current text-[#25D366] text-[#ffffff] dark:hover:text-[#ff00ff] dark-red:hover:text-[#8b1a1a]"
  >
    <path
...
>
  <svg
    ...
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    className="fill-current text-[#ffffff] hover:text-blue dark:hover:text-[#ff00ff] dark-red:hover:text-[#8b1a1a] "
  >
    <path
