...
<header className={`header ${stickyMenu ? "header--sticky" : ""}`}>
...
>  
 <div className="w-1/3">
      ...
      <button
        ...
        className="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-[#ffffff] rounded"
      >
        Theme: {theme.charAt(0).toUpperCase() + theme.slice(1)} ⌄
      </button>

      {menuOpen && (
        <ul className="absolute mt-2 w-40 bg-white dark:bg-[#000000] border border-gray-300 dark:border-gray-600 rounded shadow-lg">
          <li
          ...
          >
           ...
           <li
            ...
            className="px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer dark-red:bg-[#8b1a1a]"
          >
           Dark Red
          </li>
...
<div className="header__logo-wrapper w-1/3 flex justify-center">
  ...
  <div className="cart-wrapper">
    ...
    <div className="cart-inner">
      ...
      <button onClick={handleOpenCartModal} className="cart-button">
        <span className="cart-icon fill-current text-[#3c75e0ff]">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
            ...
            className="fill-current text-[#3c75e0ff] dark:text-[#ff00ff] dark-red:text-[#8b1a1a]"
...
/>
        ...
        <div>
          ...
          <p className="cart-price">{totalPrice} L.E</p>
        </div>
      </button>
      ...
      <div className="border-t border-[#ffffff] dark:border-[#ff00ff] dark-red:border-[#8b1a1a]">
